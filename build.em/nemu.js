...
var ASM_CONSTS = {
  91172: ($0, $1) => { const len = $0; const bufferPtr = $1; const memoryBuffer = new Uint8Array(Module.HEAPU8.buffer, bufferPtr, len); let pixelBuffer = Array.from(memoryBuffer); Module.renderScreen(JSON.stringify(pixelBuffer)); }
};
